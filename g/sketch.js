...
function setup() { 
  ...
  function draw() { 
    ...
    //ellipse(0, 0, sin(t / x) * s, cos(t / y) * s);
		...
		rect(sin(t / x) * s, cos(t / y) * s, atan(t / x) * s, cos(t / y) * s);
		
  };
  
  // save as a jpg
  function saveArt() {
    saveCanvas( 'sketchF', 'jpg')
  }
