...
function setup() { 
  ...
  function draw() { 
    ...
    rotate(t/r);
    line(sin(t / x) * s, cos(t / y) * s, atan(t / x) * s, cos(t / y) * s);
  };
  
  // save as a jpg
  function saveArt() {
    saveCanvas( 'sketchC', 'jpg')
  }
